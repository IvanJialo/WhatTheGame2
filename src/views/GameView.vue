          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center gap-2 mt-4">
              <button v-if="user" @click="toggleFavorite(route.params.id)"
                class="group relative flex items-center gap-2 text-sm md:text-base px-4 py-2 rounded-full bg-[#8a70d6]/20 hover:bg-[#8a70d6]/30 text-[#8a70d6] dark:bg-[#b197ff]/20 dark:hover:bg-[#b197ff]/30 dark:text-[#b197ff] transition duration-300 shadow-sm font-semibold">
                <svg xmlns="http://www.w3.org/2000/svg"
                  :class="['h-5 w-5 transition-all duration-300', isFavorite ? 'fill-red-500 scale-125' : 'fill-[#b197ff] group-hover:scale-110']"
                  viewBox="0 0 24 24">
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42
                    4.42 3 7.5 3c1.74 0 3.41 0.81
                    4.5 2.09C13.09 3.81 14.76 3 16.5
                    3 19.58 3 22 5.42 22 8.5c0
                    3.78-3.4 6.86-3.4 6.86-8.55 11.54L12 21.35z" 
                  />
                </svg>
